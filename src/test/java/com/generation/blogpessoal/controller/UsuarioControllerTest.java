...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Paulo Antunes", 
				"paulo_antunes@gmail.com.br", "13465278", "-"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Maria da Silva", 
				"maria_silva@gmail.com.br", "13465278", "-"));
	...
	public void deveMostrarTodosOsUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Sabrina Sanches", "sabrina_sanches@gmail.com.br", 
				"sabrina123", "-"));
		
		usuarioService.cadastrarUsuario(new Usuario(0L, "Ricardo Marques", "ricardo_marques@gmail.com.br", 
				"ricardo123", "-"));
